...
public class Async {
    ...
    public synchronized static void shutDown() {
        final ExecutorService exe = mThreadPoolExecutor;
...
//            Log.d(CopierBottomSheet.TAG, "executeSafely: same thread");
    ...
    public static class CExecutor implements Canceller {
        ...
        public void execute(@NotNull CRun cRun) {
            ensurePreConditions();
            future = getThreadPoolExecutor().submit(() -> cRun.run(CExecutor.this));
        }
    ...
    public static abstract class Executor<Input, Progress, Output> implements Canceller {
         ...
         *
         * @throws IllegalStateException if {@link #getThreadPoolExecutor()} is already shut down or if {@link #isRunning()}
         * @throws java.util.concurrent.RejectedExecutionException if {@link #getThreadPoolExecutor()} rejects execution
         * */
        public void execute(final Input input) {
            ...
            onStart();
            future = getThreadPoolExecutor().submit(backTask);
        }
